...
def newneuralnet():
    ...
    with open("outputexample.html","w") as fl:
        fl.write(splime_output_new)
...
def newrandomforest():
    ...
    return render_template('testpart2mod.html',html_output = splime_output_new,score = round(100*metrics.accuracy_score(y_test,y_pred),2),dp = droppedfeatures)
...
def newxgbmodel():
    ...
    return render_template('testpart3mod.html',html_output = splime_output_new,score = round(100*metrics.accuracy_score(y_test,y_pred),2),dp=droppedfeatures)
...
def newlgb():
    ...
    return render_template('testpart4mod.html',html_output = splime_output_new,score = round(100*metrics.accuracy_score(y_test,y_pred),2),dp = droppedfeatures)
